package com.demo.security.aop;

;
import com.alibaba.fastjson.JSON;
import com.demo.security.annotation.Secret;
import com.demo.security.utils.AESUtils;
import com.demo.security.vo.ResultVO;
...
public class SecretAOPController {
    ...
    @Pointcut("@within(com.demo.security.annotation.Secret) || @annotation(com.demo.security.annotation.Secret)")
