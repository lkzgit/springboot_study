...
public class TokenService
{
    ...
    public LoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            ...
            String cacheObject = redisCache.getCacheObject(userKey);
            LoginUser user = Convert.getObject(cacheObject, LoginUser.class);
    ...
    public void refreshToken(LoginUser loginUser)
    {
        ...
        redisCache.setCacheObject(userKey,Convert.getJson(loginUser), expireTime, TimeUnit.MINUTES);
    }
