 ...
 */
@RestController
public class ComsumerController2 {
    ...
    public String test(HttpServletRequest request){
        ...
        Map<String, byte[]> consumer = redisService.getCacheMap("consumerKeyPair");
        //获取自己的公钥
        String publicKey = PublicMethodUtils.returnPublic(consumer);
        // 返回给对方自己的公钥
        return publicKey;
    }
    ...
    public String getToken(HttpServletRequest request) throws Exception {
        ...
        serverInfo.put("oppoPublicKey",redisService.getCacheObject("consumer:userPublicKey"));
        Map<String, byte[]> userKey = redisService.getCacheMap("consumerKeyPair");
        String url="localhost:1113/generateToken";
    ...
    public Map generateToken(HttpServletRequest request) throws Exception {
